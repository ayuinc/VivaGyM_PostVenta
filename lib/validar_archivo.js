    ...
    if(ext=="jpg" || ext=="JPG" || ext=="jpeg" || ext=="JPEG" || ext=="bmp" || ext=="BMP" || ext=="gif" || ext=="GIF")
     ...
     { 
        ...
        { 
            ...
            if (iSize > 1){ 
                $("#lblSize").html( "El peso del archivo adjunto " + iSize + "Gb. es mayor al permitido.");
        ...
        { 
            ...
            if (iSize > 2){
              $("#lblSize").html( "El peso del archivo adjunto " + iSize + "Mb. es mayor al permitido.");
              document.getElementById('grupo_boton').disabled="disabled";
              document.getElementById('lblSize').style.display="block";
            }
              ...
              {
                $("#lblSize").html( "El peso del archivo adjunto " + iSize + "Mb. está dentro de lo permitido.");
                document.getElementById('lblSize').style.display="block";
                document.getElementById('grupo_boton').disabled="";
              }
        } 
     ...
     else 
     {
        ...
        $("#lblSize").html( "El peso del archivo adjunto " + iSize + "Kb. está dentro de lo permitido.");
        document.getElementById('lblSize').style.display="block";
        document.getElementById('grupo_boton').disabled="";
     }    
  }); 
